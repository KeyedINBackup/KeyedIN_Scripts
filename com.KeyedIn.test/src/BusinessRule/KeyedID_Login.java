...
FileReader ff = new FileReader("C:\\Selenium\\com.KeyedIn.test\\src\\KeyedIN\\Data\\KeyedIN_Attributes.txt");
...
FileReader ff = new FileReader("C:\\Selenium\\com.KeyedIn.test\\src\\KeyedIN\\Data\\KeyedIN_TestData.txt");
Properties pp = new Properties();
pp.load(ff);
return(pp);
}
public static void Login1() throws IOException, AWTException
{
try{
